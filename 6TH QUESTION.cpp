...
void maxnum(struct books b[],int n)
{
printf("BOOK WITH THE MAXIMUM NUMBER OF PAGES-\n");
int max=b[0].pages;
for(int i=0;i<n;i++)
{
	if(max<b[i].pages)
...
void moneyearn(struct books b[],int n)
{
printf("TOTAL AMOUNT OF MONEY EARNED BY SELLING BOOKS\n");
